      ...
      <main className="w-full lg:w-1/2 bg-white flex flex-col items-center justify-center p-8 md:p-16 lg:p-24 relative">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 py-3 border border-[#D7E2EB] rounded-xl font-semibold text-[15px] text-[#171c1e] hover:bg-[#eaeef0] transition-colors"
              style={{ fontFamily: "'Hanken Grotesk', sans-serif" }}>
            ...
            <button className="flex items-center justify-center gap-3 py-3 border border-[#D7E2EB] rounded-xl font-semibold text-[15px] text-[#171c1e] hover:bg-[#eaeef0] transition-colors"
              ...
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M17.05 20.28c-.98.95-2.05 1.83-3.23 1.83-1.15 0-1.52-.72-2.82-.72-1.32 0-1.74.71-2.8.71-1.15 0-2.31-.95-3.23-1.83-1.88-1.8-3.32-5.09-3.32-8.15 0-4.91 3.12-7.51 6.11-7.51 1.57 0 3.06.6 4.02 1.37.95-.77 2.45-1.37 4.02-1.37 1.53 0 2.92.57 3.84 1.4-1.3.82-2.18 2.27-2.18 3.93 0 2 1.25 3.52 2.98 4.19-.18.52-.4 1.05-.67 1.57-.48.91-1.02 1.82-1.68 2.6zM13.68 1.48c0 1.95-1.6 3.54-3.57 3.54-.03-.43-.05-.86-.05-1.29 0-1.95 1.6-3.54 3.57-3.54.02.43.05.86.05 1.29z" />
              </svg>
              Apple
            </button>
          </div>
